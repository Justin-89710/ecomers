...
if (isset($_POST['Submit_Code'])){
    //get password one and two from form
    ...
    } elseif (strlen($first_password) < 8) {
...
<div class="container" id="container">
    ...
    <div class="form-container sign-in-container">
        <form METHOD="post">
            ...
            <input type="password" name="first_password" placeholder="New Password">
            <input type="password" name="second_password" placeholder="Confirm Password">
            <button name="Submit_Code">Submit new password</button>
            <span>after you submit this for you will be sent to the login page where you can login with your new password!</span>
        </form>
    </div>
