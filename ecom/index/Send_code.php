...
if (isset($_POST['Submit_Code'])){
    ...
    if (empty($Email)) {
        ...
        if (!$row) {
            ...
            $headers = "From: Ecom site";
            mail($to, $subject, $message, $headers);
            // store code in session
            $_SESSION['code'] = $code;
            $_SESSION['Email'] = $Email;
            header("Location: input_code.php");
            exit();
        }
    }
...
<div class="container" id="container">
    ...
    <div class="form-container sign-in-container">
        <form METHOD="post">
            ...
            <input type="email" placeholder="Email" name="Email"  />
            <button name="Submit_Code">Send code</button>
            <br>
            <span>After you submit this form you will get a mail with a code on the mail you submit.</span>
        </form>
    </div>
